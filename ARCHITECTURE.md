...
export.js          ← 导出层：Excel 导出 (依赖 CDN + models)
  ↓
demo-data.js       ← 数据源：5 机型定义 + 工厂函数 (依赖 models)
  ↓
...
SystemProfile {
  id: string                  // 内部 UUID
  productName: string         // 如 "FusionServer 2288H V7"
  systemId: string            // 如 "FUSION_2288HV7"
  firmwareVersion: string     // 如 "iBMC V690 v3.45"
...
| `js/demo-data.js` | 697 | 5 机型示例数据 + 工厂函数 | 中 |
